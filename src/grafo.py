from networkx import Graph, get_edge_attributes, circular_layout
...
class Grafo:
    ...
    def criar_grafo(self, entrada):
        ...
        self.pos = circular_layout(self.grafo)
        return True
    ...
    def prim(self):
        ...
        arestas = [
            (no_inicial, vizinho, data["weight"])
            for vizinho, data in self.grafo[no_inicial].items()
        ]
    ...
    def get_rotulo(self):
        return get_edge_attributes(self.grafo, "weight")
